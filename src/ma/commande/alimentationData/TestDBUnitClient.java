 ...
 */
public class TestDBUnitClient extends DBTestCase {
	/** Logger. */
	private static final Logger LOGGER = RootLogger.getLogger(DBTestCase.class);
	/** Driver JDBC. */
	private static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
	/**
	 * Base de données MYSQL nommée "database" qui fonctionne en mode mémoire.
	 */
	private static final String DATABASE = "jdbc:mysql://localhost/db_commandes";
	 ...
	 * @throws Exception
	 */
	public TestDBUnitClient(String name) {
		super(name);
